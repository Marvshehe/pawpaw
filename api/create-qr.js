const PAYMONGO_SECRET_KEY = "sk_live_tCwh1ZfdrLU6ZAAC11aHQmpA"; // ← put your real PayMongo secret key here
      ...
      body: JSON.stringify({
        data: {
          attributes: {
            ...
            description: description || "Marv's Burgers Order",
            statement_descriptor: "MarvsBurgers",
          },
        },
      }),
    });
